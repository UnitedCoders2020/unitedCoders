...
public class paybillTest {
    ...
    public static void validBillPay() {
        ...
        String Amount_before_payment=PayBills.AccountDetails();
        
        String success = PayBills.billpay();
        String Amount_after_payment=PayBills.AccountDetails();
        
        if (!(Amount_after_payment.equals(Amount_before_payment))) {
            logger.log(Status.PASS, "Amount verified after Bill Payment.");
        }
    ...
    public static void invalidBillPay() {
        ...
        String stateErr =PayBills.stateError();
        String zipcodeErr =PayBills.zipcodeError();
        String phone_numberErr = PayBills.PhonenumberError();
        String account_numberErr =PayBills.accountError();
        String accountmismatchErr = PayBills.accountMismatchError();
        String verify_account_numberErr = PayBills.verify_accountError();
        String amountErr =PayBills.amountError();
